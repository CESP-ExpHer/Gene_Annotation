...
If you click on the **"Human"** Tab on the website, it is possible to use **"Current release"** for the Human.
<br></br>
<kbd> <img src="0_Images/Slide5.PNG"/> </kbd>
<br></br>
Here are the files for the latest release. However, they are for **hg38** assembly version. So, you could click on **"Go to GRCh37 version of this release"**.
<br></br>
<kbd> <img src="0_Images/Slide6.PNG"/> </kbd>
<br></br>
On this page, you will see the **GRCh37** data. But if you note, it is mentioned that *"gene annotation originally created on the GRCh38 reference chromosomes, mapped to the GRCh37 primary assembly with gencode-backmap"*. So, it is not what we are looking for.
<br></br>
...
<br></br>
So, on this page, you could download a gene annotation file in a *GTF* file format.<br>
As you can see, there are two files: the *main annotation* file AND the *superset of the main annotation* file. We downloaded both files for further analysis.
<br></br>
...
<br></br>
On the Ensemble webpage, you need to click on the **"Human"** option.
<br></br>
...
<br></br>
Similar to the previous assembly page, we expected to obtain the annotation file by clicking on the **"Gene annotation"** box. But the links on this page do NOT work:
<br></br>
...
<br></br>
### BioMart Tool
If you look at the Ensembl webpage, you could see **"BioMart"** at the top of the screen.
<br></br>
<kbd> <img src="0_Images/Slide20.PNG"/> </kbd>
<br></br>
In Wikipedia, you see that *"BioMart is a community-driven project to provide a single point of access to distributed research data."*<br>
You could select different datasets through **"CHOOSE DATABASE"** drop-down menu on the BioMart page to download different data.
<br></br>
...
<br></br>
You could set **"Filters"** and add **"Attributes"** to the dataset to choose what you want to be downloaded.<br>
Then, click on the **"Results"** button to see 10 lines of the result.<br>
To download the data, after choosing the output file format, click on the **"Go"** button.
<br></br>
...
<br></br>
But if you see next to the **"Go"** button, there is an option called **"Unique results only"**. So, selecting that option, we downloaded the next annotation data:
<br></br>
...
<br></br>
In the Table browser, by default, there is no Gene symbol column for downloaded data. For adding a Gene Symbol, you should link the official gene symbol via a linkage between the known gene table and the *kgXref table* in the human assembly as follows:<br>
Select the following parameters:<br>
**group:** Genes and Gene Predictions<br>
**track:** UCSC Genes<br>
**table:** knownGene<br>
Then, using the **"paste list"** button, you should upload a list of UCSC IDs into the Table Browser.<br> 
...
**NOTE:** If you see the *"README_GRCh37_mapping.txt"*, you find that this file contains GENCODE annotation originally built on GRCh38 that has been *mapped back* to the GRCh37 assembly.
So, we have the 7th annotation file:
<br></br>
<kbd> <img src="0_Images/Slide32.PNG"/> </kbd>
<br></br>
### FANTOM Database
For the FANTOM annotation file, you need to go to the FANTOM project webpage:
<br></br>
...
<br></br>
Now you can go to the [Analysis Section](../1_Analyzing) to see the similarities and differences of these annotation files.
